...
void CG_DrawConnectScreen(qboolean interactive, qboolean forcerefresh)
{
	...
	if (*buffer)
	{
		...
		y = 322;
		CG_Text_Paint_Centred_Ext(540, y, 0.22f, 0.22f, clr3, "TJMod " TJMOD_VERSION, 0, 0, 0, &bg_loadscreenfont1);

		y = 340;
		str = Info_ValueForKey(buffer, "sv_hostname");
		CG_Text_Paint_Centred_Ext(540, y, 0.2f, 0.2f, colorWhite, str && *str ? str : "ETHost - TJMod", 0, 26, 0, &bg_loadscreenfont2);
