...
typedef struct
{
	...
	vec4_t			keysColor;
	vec4_t			yawColor;
	vec4_t			compassColor1;
	vec4_t			compassColor1_strong;
	vec4_t			compassColor2;
	vec4_t			compassColor2_strong;
	vec4_t			compassColor3;
	vec4_t			compassColor3_strong;
	vec4_t			compassColor4;
	vec4_t			compassColor4_strong;

	vec4_t			speedColor;
	vec4_t			timerColor;
	vec4_t			timerColorSlower;
	vec4_t			avgspeedColor;
	vec4_t			rundistColor;
	...
	int				timerunChecked;
	int				timerunCheckpoint;
	int				timerunCheckpointDiff;
	int				timerunCheckpointTime;
	char			timerunCheckIsFaster;
...
typedef struct timerunStats_s
{
	int	times[MAX_TIMERUNS];
	int	clientID;
	int	fadeTime;
	int	show;
	int	requestTime;
...
extern vmCvar_t			cg_drawoldCompass;
...
extern vmCvar_t			cg_tjrefereePassword;
...
extern	vmCvar_t		tj_nofatigue;

extern	vmCvar_t		tj_drawKeys;
extern	vmCvar_t		tj_keysX;
extern	vmCvar_t		tj_keysY;
extern	vmCvar_t		tj_keysSize;
// Dini, colorization of drawkeys
extern	vmCvar_t		tj_keysColor;
extern	vmCvar_t		tj_keysColorAlpha;

extern	vmCvar_t		tj_drawCGaz;
extern	vmCvar_t		tj_CGazY;
extern	vmCvar_t		tj_CGazHeight;
extern	vmCvar_t		tj_CGazWidth;
extern	vmCvar_t		tj_CGazAlpha;

// Dini, optionally draw the info
extern	vmCvar_t		tj_CGazInfo;

// Dini, speedometer from etpub
// forty - speedometer
extern	vmCvar_t		tj_drawspeed;
extern	vmCvar_t		tj_speedinterval;
extern	vmCvar_t		tj_speedXYonly;
extern	vmCvar_t		tj_speedunit;

extern	vmCvar_t		tj_resetVelocityOnLoad;

// Dini, clock
extern vmCvar_t			tj_drawClock;
float CG_DrawTime(float y);

// Dini, better hud!
extern vmCvar_t			tjh_enable;
// Dini, Disable pointless messages
extern vmCvar_t			tjh_messages;

// Hide players at close range stuff
extern vmCvar_t			tj_hide;
extern vmCvar_t			tj_hideDist;

extern vmCvar_t			tj_drawSpeedBar;
extern vmCvar_t			tj_speedBarMax;
extern vmCvar_t			tj_drawAccelBar;

extern vmCvar_t			tj_drawCompass;
extern vmCvar_t			tj_compassY;
extern vmCvar_t			tj_compassHeight;
extern vmCvar_t			tj_compassAlpha;
extern vmCvar_t			tj_compassAlphaAlt;
extern vmCvar_t			tj_compassColor1;
extern vmCvar_t			tj_compassColor2;
extern vmCvar_t			tj_compassColor3;
extern vmCvar_t			tj_compassColor4;

extern vmCvar_t			tj_drawYaw;
extern vmCvar_t			tj_yawColor;
extern vmCvar_t			tj_yawColorAlpha;

extern vmCvar_t			tj_drawStatus;
extern vmCvar_t			tj_drawHealth;
extern vmCvar_t			tj_drawHealthBar;
extern vmCvar_t			tj_drawStaminaBar;

extern vmCvar_t			tj_effects;

extern vmCvar_t			tj_drawCP;
extern vmCvar_t			tj_drawBP;
extern vmCvar_t			tj_drawCPM;

extern vmCvar_t			tj_viewlog;
extern vmCvar_t			tj_wolffog;
extern vmCvar_t			tj_autologin;
extern vmCvar_t			tj_autodemo;
extern vmCvar_t			tj_demoname;

extern vmCvar_t			tj_drawTimer;
extern vmCvar_t			tj_drawTimerChecks;
extern vmCvar_t			tj_timerX;
extern vmCvar_t			tj_timerY;
extern vmCvar_t			tj_timerSizeX;
extern vmCvar_t			tj_timerSizeY;
extern vmCvar_t			tj_timerColor;
extern vmCvar_t			tj_timerColorChange;
extern vmCvar_t			tj_timerColorSlower;
extern vmCvar_t			tj_timerAlpha;

extern vmCvar_t			tj_timerChecksX;
extern vmCvar_t			tj_timerChecksY;
extern vmCvar_t			tj_timerChecksSizeX;
extern vmCvar_t			tj_timerChecksSizeY;
extern vmCvar_t			tj_timerChecksColorNone;
extern vmCvar_t			tj_timerChecksColorSame;
extern vmCvar_t			tj_timerChecksColorSlow;
extern vmCvar_t			tj_timerChecksColorFast;
extern vmCvar_t			tj_timerChecksAlpha;
extern vmCvar_t			tj_timerChecksOffset;
extern vmCvar_t			tj_timerChecksExt;
extern vmCvar_t			tj_timerChecksOrder;
extern vmCvar_t			tj_timerChecksMax;

extern vmCvar_t			tj_drawrundist;
extern vmCvar_t			tj_rundistX;
extern vmCvar_t			tj_rundistY;
extern vmCvar_t			tj_rundistSizeX;
extern vmCvar_t			tj_rundistSizeY;
extern vmCvar_t			tj_rundistColor;
extern vmCvar_t			tj_rundistAlpha;

extern vmCvar_t			tj_drawavgspeed;
extern vmCvar_t			tj_avgspeedX;
extern vmCvar_t			tj_avgspeedY;
extern vmCvar_t			tj_avgspeedSizeX;
extern vmCvar_t			tj_avgspeedSizeY;
extern vmCvar_t			tj_avgspeedColor;
extern vmCvar_t			tj_avgspeedAlpha;

extern vmCvar_t			tj_drawStartSpeed;
extern vmCvar_t			tj_startSpeedX;
extern vmCvar_t			tj_startSpeedY;
extern vmCvar_t			tj_drawJumps;

extern vmCvar_t			tj_drawGS;
extern vmCvar_t			tj_gsX;
extern vmCvar_t			tj_gsY;
extern vmCvar_t			tj_gsHeight;
extern vmCvar_t			tj_gsWidth;
extern vmCvar_t			tj_gsInterval;
extern vmCvar_t			tj_gsColor1;
extern vmCvar_t			tj_gsColor2;
extern vmCvar_t			tj_gsColor3;
extern vmCvar_t			tj_gsAlpha1;
extern vmCvar_t			tj_gsAlpha2;
extern vmCvar_t			tj_gsAlpha3;
extern vmCvar_t			tj_gsCeiling;
extern vmCvar_t			tj_gsMax;
extern vmCvar_t			tj_gsSpacing;
extern vmCvar_t			tj_gsSpacing2;
extern vmCvar_t			tj_gsW;
extern vmCvar_t			tj_gsFade;
extern vmCvar_t			tj_gsImage;

extern vmCvar_t			tj_drawSpeed2;
extern vmCvar_t			tj_speedX;
extern vmCvar_t			tj_speedY;
extern vmCvar_t			tj_speedSizeX;
extern vmCvar_t			tj_speedSizeY;
extern vmCvar_t			tj_speedColor;
extern vmCvar_t			tj_speedAlpha;

extern vmCvar_t			tj_warnings;
extern vmCvar_t			tj_printBanners;
extern vmCvar_t			tj_bannerShadow;
extern vmCvar_t			tj_bannerY;
extern vmCvar_t			tj_bannerSizeX;
extern vmCvar_t			tj_bannerSizeY;
extern vmCvar_t			tj_bannerTime;

extern vmCvar_t			tj_loadViewAngles;
extern vmCvar_t			tjkey;
extern vmCvar_t			tj_hideme;

extern vmCvar_t			tj_cpmTimes;
extern vmCvar_t			tj_bpTimes;
...
extern vmCvar_t			tj_drawOB;

extern vmCvar_t			tj_drawminiview;
extern vmCvar_t			tj_miniviewx;
extern vmCvar_t			tj_miniviewy;
extern vmCvar_t			tj_minivieww;
extern vmCvar_t			tj_miniviewh;
extern vmCvar_t			tj_miniviewdist;
extern vmCvar_t			tj_miniviewangle;
extern vmCvar_t			tj_miniviewangle2;


// cg_predict.c
extern pmove_t			cg_pmove;

extern vmCvar_t			tj_brassflash;

extern vmCvar_t			tjmod_pass;
extern vmCvar_t			tjg_votewait;

extern vmCvar_t			tj_noclipscale;
