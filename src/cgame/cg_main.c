...
vmCvar_t	tj_nofatigue;

vmCvar_t	tj_drawKeys;
vmCvar_t	tj_keysX;
vmCvar_t	tj_keysY;
vmCvar_t	tj_keysSize;
// Dini, colorize keys
vmCvar_t	tj_keysColor;
vmCvar_t	tj_keysColorAlpha;

vmCvar_t	tj_drawCGaz;
vmCvar_t	tj_CGazY;
vmCvar_t	tj_CGazHeight;
vmCvar_t	tj_CGazWidth;
vmCvar_t	tj_CGazAlpha;

// Dini, optionally draw cgaz info
vmCvar_t	tj_CGazInfo;

// Dini, speedometer from etpub
// forty - speedometer
vmCvar_t	tj_drawspeed;
vmCvar_t	tj_speedinterval;
vmCvar_t	tj_speedXYonly;
vmCvar_t	tj_speedunit;

vmCvar_t	tj_resetVelocityOnLoad;

// Dini, clock
vmCvar_t	tj_drawClock;

// Dini, better hud
vmCvar_t	tjh_enable;
// Dini, disable pointless messages
vmCvar_t	tjh_messages;

// Hide players at close range stuff
vmCvar_t	tj_hide;
vmCvar_t	tj_hideDist;

vmCvar_t	tj_drawSpeedBar;
vmCvar_t	tj_speedBarMax;
vmCvar_t	tj_drawAccelBar;

vmCvar_t	tj_drawCompass;
vmCvar_t	tj_compassY;
vmCvar_t	tj_compassHeight;
vmCvar_t	tj_compassAlpha;
vmCvar_t	tj_compassAlphaAlt;
vmCvar_t	tj_compassColor1;
vmCvar_t	tj_compassColor2;
vmCvar_t	tj_compassColor3;
vmCvar_t	tj_compassColor4;

vmCvar_t	tj_drawYaw;
vmCvar_t	tj_yawColor;
vmCvar_t	tj_yawColorAlpha;

vmCvar_t	tj_drawStatus;
vmCvar_t	tj_drawHealth;
vmCvar_t	tj_drawHealthBar;
vmCvar_t	tj_drawStaminaBar;

vmCvar_t	tj_effects;

vmCvar_t	tj_autoLogin;
vmCvar_t	tj_autodemo;
vmCvar_t	tj_demoname;

vmCvar_t	tj_drawTimer;
vmCvar_t	tj_drawTimerChecks;
vmCvar_t	tj_timerX;
vmCvar_t	tj_timerY;
vmCvar_t	tj_timerSizeX;
vmCvar_t	tj_timerSizeY;
vmCvar_t	tj_timerColor;
vmCvar_t	tj_timerColorChange;
vmCvar_t	tj_timerColorSlower;
vmCvar_t	tj_timerAlpha;

vmCvar_t	tj_timerChecksX;
vmCvar_t	tj_timerChecksY;
vmCvar_t	tj_timerChecksSizeX;
vmCvar_t	tj_timerChecksSizeY;
vmCvar_t	tj_timerChecksColorNone;
vmCvar_t	tj_timerChecksColorSame;
vmCvar_t	tj_timerChecksColorSlow;
vmCvar_t	tj_timerChecksColorFast;
vmCvar_t	tj_timerChecksAlpha;
vmCvar_t	tj_timerChecksOffset;
vmCvar_t	tj_timerChecksExt;
vmCvar_t	tj_timerChecksOrder;
vmCvar_t	tj_timerChecksMax;

vmCvar_t	tj_drawrundist;
vmCvar_t	tj_rundistX;
vmCvar_t	tj_rundistY;
vmCvar_t	tj_rundistSizeX;
vmCvar_t	tj_rundistSizeY;
vmCvar_t	tj_rundistColor;
vmCvar_t	tj_rundistAlpha;

vmCvar_t	tj_drawavgspeed;
vmCvar_t	tj_avgspeedX;
vmCvar_t	tj_avgspeedY;
vmCvar_t	tj_avgspeedSizeX;
vmCvar_t	tj_avgspeedSizeY;
vmCvar_t	tj_avgspeedColor;
vmCvar_t	tj_avgspeedAlpha;

vmCvar_t	tj_drawSpeed2;
vmCvar_t	tj_speedX;
vmCvar_t	tj_speedY;
vmCvar_t	tj_speedSizeX;
vmCvar_t	tj_speedSizeY;
vmCvar_t	tj_speedColor;
vmCvar_t	tj_speedAlpha;

vmCvar_t	tj_drawStartSpeed;
vmCvar_t	tj_startSpeedX;
vmCvar_t	tj_startSpeedY;
vmCvar_t	tj_drawJumps;

vmCvar_t	tj_drawGS;
vmCvar_t	tj_gsX;
vmCvar_t	tj_gsY;
vmCvar_t	tj_gsHeight;
vmCvar_t	tj_gsWidth;
vmCvar_t	tj_gsInterval;
vmCvar_t	tj_gsColor1;
vmCvar_t	tj_gsColor2;
vmCvar_t	tj_gsColor3;
vmCvar_t	tj_gsAlpha1;
vmCvar_t	tj_gsAlpha2;
vmCvar_t	tj_gsAlpha3;
vmCvar_t	tj_gsCeiling;
vmCvar_t	tj_gsMax;
vmCvar_t	tj_gsSpacing;
vmCvar_t	tj_gsSpacing2;
vmCvar_t	tj_gsW;
vmCvar_t	tj_gsFade;
vmCvar_t	tj_gsImage;

vmCvar_t	tj_warnings;
vmCvar_t	tj_printBanners;
vmCvar_t	tj_bannerY;
vmCvar_t	tj_bannerShadow;
vmCvar_t	tj_bannerSizeX;
vmCvar_t	tj_bannerSizeY;
vmCvar_t	tj_bannerTime;

vmCvar_t	tj_drawCP;
vmCvar_t	tj_drawBP;
vmCvar_t	tj_drawCPM;

vmCvar_t	tj_loadViewAngles;
vmCvar_t	tj_viewlog;
vmCvar_t	tj_wolffog;
vmCvar_t	com_maxfps;
vmCvar_t	tjkey;
...
cvarTable_t		cvarTable[] =
{
	...
	// Dini, TJMod cvars allowed \ changed
	...
	// Enable by defaaaault
	{ &pmove_fixed, "pmove_fixed", "1", 0},

	// Dini, only allow pmove_msec changes if cheats are enabled.
	...
	{ &cg_specHelp, "cg_specHelp", "0", CVAR_ARCHIVE },
	...
	// Engine mappings
	{ &int_cl_maxpackets, "cl_maxpackets", "100", CVAR_ARCHIVE },
	...
	{ &cg_tjrefereePassword, "auth_tjrefereePassword", "", CVAR_TEMP},
	...
	{ &tj_nofatigue, "tj_nofatigue", "1", CVAR_ARCHIVE },

	{ &tj_drawKeys, "tj_drawKeys", "1", CVAR_ARCHIVE },
	{ &tj_keysX, "tj_keysX", "585", CVAR_ARCHIVE },
	{ &tj_keysY, "tj_keysY", "200", CVAR_ARCHIVE },
	{ &tj_keysSize, "tj_keysSize", "48", CVAR_ARCHIVE },
	// Dini, colorize keys
	{ &tj_keysColor, "tj_keysColor", "white", CVAR_ARCHIVE },
	{ &tj_keysColorAlpha, "tj_keysColorAlpha", "1", CVAR_ARCHIVE },

	{ &tj_drawCGaz, "tj_drawCGaz", "0", CVAR_ARCHIVE },
	{ &tj_CGazY, "tj_CGazY", "260", CVAR_ARCHIVE },
	{ &tj_CGazHeight, "tj_CGazHeight", "20", CVAR_ARCHIVE },
	{ &tj_CGazWidth, "tj_CGazWidth", "300", CVAR_ARCHIVE },
	{ &tj_CGazAlpha, "tj_CGazAlpha", "0.15", CVAR_ARCHIVE },

	// Dini, optionally draw the info
	{ &tj_CGazInfo, "tj_CGazInfo", "0", CVAR_ARCHIVE },

	// Dini, speedometer from etpub
	// forty - speedometer
	{ &tj_drawspeed, "tj_drawspeed", "1", CVAR_ARCHIVE },
	{ &tj_speedXYonly, "tj_speedXYonly", "1", CVAR_ARCHIVE },
	{ &tj_speedinterval, "tj_speedinterval", "100", CVAR_ARCHIVE },
	{ &tj_speedunit, "tj_speedunit", "0", CVAR_ARCHIVE },

	{ &tj_resetVelocityOnLoad, "tj_resetVelocityOnLoad", "1", CVAR_ARCHIVE },

	// Dini, clock
	{ &tj_drawClock, "tj_drawClock", "1", CVAR_ARCHIVE },

	// Dini, better hud
	{ &tjh_enable, "tjh_enable", "1", CVAR_ARCHIVE },

	// Dini, disable pointless messages
	{ &tjh_messages, "tjh_messages", "1", CVAR_ARCHIVE },

	// Hide players at close range stuff
	{ &tj_hide, "tj_hide", "0", CVAR_ARCHIVE },
	{ &tj_hideDist, "tj_hideDist", "256", CVAR_ARCHIVE },

	{ &tj_drawSpeedBar, "tj_drawSpeedBar", "1", CVAR_ARCHIVE },
	{ &tj_speedBarMax, "tj_speedBarMax", "2500", CVAR_ARCHIVE },
	{ &tj_drawAccelBar, "tj_drawAccelBar", "0", CVAR_ARCHIVE },

	{ &tj_drawStatus, "tj_drawStatus", "1", CVAR_ARCHIVE },
	{ &tj_drawHealth, "tj_drawHealth", "1", CVAR_ARCHIVE },
	{ &tj_drawHealthBar, "tj_drawHealthBar", "1", CVAR_ARCHIVE },
	{ &tj_drawStaminaBar, "tj_drawStaminaBar", "1", CVAR_ARCHIVE },

	{ &tj_effects, "tj_effects", "1", CVAR_ARCHIVE },

	{ &tj_drawCompass, "tj_drawCompass", "0", CVAR_ARCHIVE },
	{ &tj_compassY, "tj_compassY", "260", CVAR_ARCHIVE },
	{ &tj_compassHeight, "tj_compassHeight", "16", CVAR_ARCHIVE },
	{ &tj_compassAlpha, "tj_compassAlpha", "0.3", CVAR_ARCHIVE },
	{ &tj_compassAlphaAlt, "tj_compassAlphaAlt", "0.5", CVAR_ARCHIVE },
	{ &tj_compassColor1, "tj_compassColor1", "blue", CVAR_ARCHIVE },
	{ &tj_compassColor2, "tj_compassColor2", "green", CVAR_ARCHIVE },
	{ &tj_compassColor3, "tj_compassColor3", "orange", CVAR_ARCHIVE },
	{ &tj_compassColor4, "tj_compassColor4", "red", CVAR_ARCHIVE },

	{ &tj_drawYaw, "tj_drawYaw", "0", CVAR_ARCHIVE },
	{ &tj_yawColor, "tj_yawColor", "white", CVAR_ARCHIVE },
	{ &tj_yawColorAlpha, "tj_yawColorAlpha", "1", CVAR_ARCHIVE },

	{ &tj_autoLogin, "tj_autoLogin", "1", CVAR_ARCHIVE },
	{ &tj_autodemo, "tj_autodemo", "0", CVAR_ARCHIVE },
	{ &tj_demoname, "tj_demoname", "0", CVAR_ARCHIVE },

	{ &tj_drawTimer, "tj_drawTimer", "1", CVAR_ARCHIVE },
	{ &tj_drawTimerChecks, "tj_drawTimerChecks", "1", CVAR_ARCHIVE },
	{ &tj_timerX, "tj_timerX", "320", CVAR_ARCHIVE },
	{ &tj_timerY, "tj_timerY", "425", CVAR_ARCHIVE },
	{ &tj_timerSizeX, "tj_timerSizeX", "3", CVAR_ARCHIVE },
	{ &tj_timerSizeY, "tj_timerSizeY", "3", CVAR_ARCHIVE },
	{ &tj_timerColor, "tj_timerColor", "white", CVAR_ARCHIVE },
	{ &tj_timerColorChange, "tj_timerColorChange", "1", CVAR_ARCHIVE },
	{ &tj_timerColorSlower, "tj_timerColorSlower", "red", CVAR_ARCHIVE },
	{ &tj_timerAlpha, "tj_timerAlpha", "1", CVAR_ARCHIVE },

	{ &tj_timerChecksX, "tj_timerChecksX", "320", CVAR_ARCHIVE },
	{ &tj_timerChecksY, "tj_timerChecksY", "440", CVAR_ARCHIVE },
	{ &tj_timerChecksSizeX, "tj_timerChecksSizeX", "2.4", CVAR_ARCHIVE },
	{ &tj_timerChecksSizeY, "tj_timerChecksSizeY", "2.4", CVAR_ARCHIVE },
	{ &tj_timerChecksColorNone, "tj_timerChecksColorNone", "white", CVAR_ARCHIVE },
	{ &tj_timerChecksColorSame, "tj_timerChecksColorSame", "0xF1F1F1", CVAR_ARCHIVE },
	{ &tj_timerChecksColorSlow, "tj_timerChecksColorSlow", "red", CVAR_ARCHIVE },
	{ &tj_timerChecksColorFast, "tj_timerChecksColorFast", "0xCCFFCC", CVAR_ARCHIVE },
	{ &tj_timerChecksAlpha, "tj_timerChecksAlpha", "0.8", CVAR_ARCHIVE },
	{ &tj_timerChecksOffset, "tj_timerChecksOffset", "15", CVAR_ARCHIVE },
	{ &tj_timerChecksExt, "tj_timerChecksExt", "0", CVAR_ARCHIVE },
	{ &tj_timerChecksOrder, "tj_timerChecksOrder", "0", CVAR_ARCHIVE },
	{ &tj_timerChecksMax, "tj_timerChecksMax", "3", CVAR_ARCHIVE },

	{ &tj_drawStartSpeed, "tj_drawStartSpeed", "0", CVAR_ARCHIVE },
	{ &tj_drawJumps, "tj_drawJumps", "0", CVAR_ARCHIVE },
	{ &tj_startSpeedX, "tj_startSpeedX", "600", CVAR_ARCHIVE },
	{ &tj_startSpeedY, "tj_startSpeedY", "20", CVAR_ARCHIVE },

	{ &tj_drawrundist, "tj_drawrundist", "0", CVAR_ARCHIVE },
	{ &tj_rundistX, "tj_rundistX", "10", CVAR_ARCHIVE },
	{ &tj_rundistY, "tj_rundistY", "20", CVAR_ARCHIVE },
	{ &tj_rundistSizeX, "tj_rundistSizeX", "2", CVAR_ARCHIVE },
	{ &tj_rundistSizeY, "tj_rundistSizeY", "2", CVAR_ARCHIVE },
	{ &tj_rundistColor, "tj_rundistColor", "white", CVAR_ARCHIVE },
	{ &tj_rundistAlpha, "tj_rundistAlpha", "1", CVAR_ARCHIVE },

	{ &tj_drawavgspeed, "tj_drawavgspeed", "0", CVAR_ARCHIVE },
	{ &tj_avgspeedX, "tj_avgspeedX", "10", CVAR_ARCHIVE },
	{ &tj_avgspeedY, "tj_avgspeedY", "40", CVAR_ARCHIVE },
	{ &tj_avgspeedSizeX, "tj_avgspeedSizeX", "2", CVAR_ARCHIVE },
	{ &tj_avgspeedSizeY, "tj_avgspeedSizeY", "2", CVAR_ARCHIVE },
	{ &tj_avgspeedColor, "tj_avgspeedColor", "white", CVAR_ARCHIVE },
	{ &tj_avgspeedAlpha, "tj_avgspeedAlpha", "1", CVAR_ARCHIVE },

	{ &tj_drawSpeed2, "tj_drawSpeed2", "1", CVAR_ARCHIVE },
	{ &tj_speedX, "tj_speedX", "320", CVAR_ARCHIVE },
	{ &tj_speedY, "tj_speedY", "400", CVAR_ARCHIVE },
	{ &tj_speedSizeX, "tj_speedSizeX", "3", CVAR_ARCHIVE },
	{ &tj_speedSizeY, "tj_speedSizeY", "3", CVAR_ARCHIVE },
	{ &tj_speedColor, "tj_speedColor", "white", CVAR_ARCHIVE },
	{ &tj_speedAlpha, "tj_speedAlpha", "1", CVAR_ARCHIVE },

	{ &tj_warnings, "tj_warnings", "1", CVAR_ARCHIVE },
	{ &tj_printBanners, "tj_printBanners", "1", CVAR_ARCHIVE },
	{ &tj_bannerShadow, "tj_bannerShadow", "0", CVAR_ARCHIVE },
	{ &tj_bannerY, "tj_bannerY", "8", CVAR_ARCHIVE },
	{ &tj_bannerSizeX, "tj_bannerSizeX", "2", CVAR_ARCHIVE },
	{ &tj_bannerSizeY, "tj_bannerSizeY", "2", CVAR_ARCHIVE },
	{ &tj_bannerTime, "tj_bannerTime", "8", CVAR_ARCHIVE },

	{ &tj_drawGS, "tj_drawGS", "0", CVAR_ARCHIVE },
	{ &tj_gsX, "tj_gsX", "320", CVAR_ARCHIVE },
	{ &tj_gsY, "tj_gsY", "0", CVAR_ARCHIVE },
	{ &tj_gsWidth, "tj_gsWidth", "20", CVAR_ARCHIVE },
	{ &tj_gsHeight, "tj_gsHeight", "100", CVAR_ARCHIVE },
	{ &tj_gsInterval, "tj_gsInterval", "0", CVAR_ARCHIVE },
	{ &tj_gsColor1, "tj_gsColor1", "0x007fff", CVAR_ARCHIVE },
	{ &tj_gsColor2, "tj_gsColor2", "0x7facda", CVAR_ARCHIVE },
	{ &tj_gsColor3, "tj_gsColor3", "0x99a9b9", CVAR_ARCHIVE },
	{ &tj_gsAlpha1, "tj_gsAlpha1", "0.3", CVAR_ARCHIVE },
	{ &tj_gsAlpha2, "tj_gsAlpha2", "0.3", CVAR_ARCHIVE },
	{ &tj_gsAlpha3, "tj_gsAlpha3", "0.3", CVAR_ARCHIVE },
	{ &tj_gsCeiling, "tj_gsCeiling", "2", CVAR_ARCHIVE },
	{ &tj_gsMax, "tj_gsMax", "20", CVAR_ARCHIVE },
	{ &tj_gsSpacing, "tj_gsSpacing", "1", CVAR_ARCHIVE },
	{ &tj_gsSpacing2, "tj_gsSpacing2", "0", CVAR_ARCHIVE },
	{ &tj_gsW, "tj_gsW", "1", CVAR_ARCHIVE },
	{ &tj_gsFade, "tj_gsFade", "0", CVAR_ARCHIVE },
	{ &tj_gsImage, "tj_gsImage", "0", CVAR_ARCHIVE },


	// Div stuff, useful to remove shit for videos if needed etc..
	{ &tj_drawCP, "tj_drawCP", "1", CVAR_ARCHIVE },
	{ &tj_drawBP, "tj_drawBP", "1", CVAR_ARCHIVE },
	{ &tj_drawCPM, "tj_drawCPM", "1", CVAR_ARCHIVE },

	{ &tj_loadViewAngles, "tj_loadViewAngles", "1", CVAR_ARCHIVE },
	// Not-so-standard-stuff
	{ &tj_viewlog, "tj_viewlog", "0", CVAR_ARCHIVE },
	{ &tj_wolffog, "tj_wolffog", "0", CVAR_ARCHIVE },
	{ &com_maxfps, "com_maxfps", "125", CVAR_ARCHIVE },
	{ &tjkey, "tjkey", "0", CVAR_ARCHIVE },
	{ &tj_hideme, "tj_hideme", "0", CVAR_ARCHIVE },

	{ &tj_cpmTimes, "tj_cpmTimes", "0", CVAR_ARCHIVE },
	{ &tj_bpTimes, "tj_bpTimes", "1", CVAR_ARCHIVE },

	// Serverside settings used for prediction clientsite
	{ &physics, "physics", "0", CVAR_ROM | CVAR_CHEAT },
	{ &isTimerun, "isTimerun", "0", CVAR_ROM | CVAR_CHEAT },
	{ &tjg_recordMode, "tjg_recordMode", "0", CVAR_ROM | CVAR_CHEAT },
	{ &tjg_disabled_ob, "tjg_disabled_ob", "0", CVAR_ROM | CVAR_CHEAT },

	{ &tj_brassflash, "tj_brassflash", "1", CVAR_ARCHIVE },
	{ &tj_drawOB, "tj_drawOB", "0", CVAR_ARCHIVE },


	{ &tj_drawminiview, "tj_drawminiview", "0", CVAR_ARCHIVE },
	{ &tj_miniviewx, "tj_miniviewx", "0", CVAR_ARCHIVE },
	{ &tj_miniviewy, "tj_miniviewy", "0", CVAR_ARCHIVE },
	{ &tj_minivieww, "tj_minivieww", "0", CVAR_ARCHIVE },
	{ &tj_miniviewh, "tj_miniviewh", "0", CVAR_ARCHIVE },
	{ &tj_miniviewdist, "tj_miniviewdist", "0", CVAR_ARCHIVE },
	{ &tj_miniviewangle, "tj_miniviewangle", "0", CVAR_ARCHIVE },
	{ &tj_miniviewangle2, "tj_miniviewangle2", "0", CVAR_ARCHIVE },

	{ &tjmod_pass, "tjmod_pass", "0", CVAR_ARCHIVE },
	{ &tj_noclipscale, "tj_noclipscale", "30", CVAR_ARCHIVE }
		...
		if (cv->vmCvar)
		{
			...
			if (cv->modificationCount != cv->vmCvar->modificationCount)
			{
				...
				if (cv->vmCvar == &cg_autoAction || cv->vmCvar == &cg_autoReload
						...
						|| cv->vmCvar == &tj_nofatigue || cv->vmCvar == &tj_resetVelocityOnLoad
						|| cv->vmCvar == &tj_autoLogin || cv->vmCvar == &pmove_fixed
						|| cv->vmCvar == &com_maxfps || cv->vmCvar == &tj_loadViewAngles
						|| cv->vmCvar == &tjkey || cv->vmCvar == &tj_hideme
						|| cv->vmCvar == &tj_cpmTimes || cv->vmCvar == &tj_bpTimes
						|| cv->vmCvar == &tjmod_pass || cv->vmCvar == &tj_noclipscale)
				{
					fSetFlags = qtrue;
				}
				...
				{
					BG_setColor(cg_crosshairColor.string, cg.xhairColor, cg_crosshairAlpha.value, "cg_crosshairColor");
				}

				else if (cv->vmCvar == &cg_crosshairColorAlt || cv->vmCvar == &cg_crosshairAlphaAlt)
				{
					BG_setColor(cg_crosshairColorAlt.string, cg.xhairColorAlt, cg_crosshairAlphaAlt.value, "cg_crosshairColorAlt");
				}

				else if (cv->vmCvar == &tj_keysColor || cv->vmCvar == &tj_keysColorAlpha)
				{
					BG_setColor(tj_keysColor.string, cg.keysColor, tj_keysColorAlpha.value, "tj_keysColor");
				}
				else if (cv->vmCvar == &tj_yawColor || cv->vmCvar == &tj_yawColorAlpha)
				{
					BG_setColor(tj_yawColor.string, cg.yawColor, tj_yawColorAlpha.value, "tj_yawColor");
				}
				else if (cv->vmCvar == &tj_compassColor1 || cv->vmCvar == &tj_compassColor2
						 ||	cv->vmCvar == &tj_compassColor3 || cv->vmCvar == &tj_compassColor4
						 ||	cv->vmCvar == &tj_compassAlpha	|| cv->vmCvar == &tj_compassAlphaAlt)
				{

					BG_setColor(tj_compassColor1.string, cg.compassColor1, tj_compassAlpha.value, "tj_compassColor1");
					BG_setColor(tj_compassColor1.string, cg.compassColor1_strong, tj_compassAlphaAlt.value, "tj_compassColor1_strong");

					BG_setColor(tj_compassColor2.string, cg.compassColor2, tj_compassAlpha.value, "tj_compassColor2");
					BG_setColor(tj_compassColor2.string, cg.compassColor2_strong, tj_compassAlphaAlt.value, "tj_compassColor2_strong");

					BG_setColor(tj_compassColor3.string, cg.compassColor3, tj_compassAlpha.value, "tj_compassColor3");
					BG_setColor(tj_compassColor3.string, cg.compassColor3_strong, tj_compassAlphaAlt.value, "tj_compassColor3_strong");

					BG_setColor(tj_compassColor4.string, cg.compassColor4, tj_compassAlpha.value, "tj_compassColor4");
					BG_setColor(tj_compassColor4.string, cg.compassColor4_strong, tj_compassAlphaAlt.value, "tj_compassColor4_strong");
				}

				else if (cv->vmCvar == &tj_timerColor || cv->vmCvar == &tj_timerAlpha)
					BG_setColor(tj_timerColor.string, cg.timerColor, tj_timerAlpha.value, "tj_timerColor");

				else if (cv->vmCvar == &tj_speedColor || cv->vmCvar == &tj_speedAlpha)
					BG_setColor(tj_speedColor.string, cg.speedColor, tj_speedAlpha.value, "tj_speedColor");

				else if (cv->vmCvar == &tj_avgspeedColor || cv->vmCvar == &tj_avgspeedAlpha)
					BG_setColor(tj_avgspeedColor.string, cg.avgspeedColor, tj_avgspeedAlpha.value, "tj_avgspeedColor");

				else if (cv->vmCvar == &tj_rundistColor || cv->vmCvar == &tj_rundistAlpha)
					BG_setColor(tj_rundistColor.string, cg.rundistColor, tj_rundistAlpha.value, "tj_rundistColor");

				else if (cv->vmCvar == &tj_timerColorSlower || cv->vmCvar == &tj_timerAlpha)
					BG_setColor(tj_timerColorSlower.string, cg.timerColorSlower, tj_timerAlpha.value, "tj_timerColorSlower");

				else if (cv->vmCvar == &tj_gsColor1 || cv->vmCvar == &tj_gsAlpha1)
					BG_setColor(tj_gsColor1.string, cg.gsColor1, tj_gsAlpha1.value, "tj_gsColor1");
				else if (cv->vmCvar == &tj_gsColor2 || cv->vmCvar == &tj_gsAlpha2)
					BG_setColor(tj_gsColor2.string, cg.gsColor2, tj_gsAlpha2.value, "tj_gsColor2");
				else if (cv->vmCvar == &tj_gsColor3 || cv->vmCvar == &tj_gsAlpha3)
					BG_setColor(tj_gsColor3.string, cg.gsColor3, tj_gsAlpha3.value, "tj_gsColor3");

				else if (cv->vmCvar == &tj_timerChecksColorNone || cv->vmCvar == &tj_timerChecksAlpha)
					BG_setColor(tj_timerChecksColorNone.string, cg.chColorNone, tj_timerChecksAlpha.value, "tj_timerChecksColorNone");
				else if (cv->vmCvar == &tj_timerChecksColorSame || cv->vmCvar == &tj_timerChecksAlpha)
					BG_setColor(tj_timerChecksColorSame.string, cg.chColorSame, tj_timerChecksAlpha.value, "tj_timerChecksColorSame");
				else if (cv->vmCvar == &tj_timerChecksColorSlow || cv->vmCvar == &tj_timerChecksAlpha)
					BG_setColor(tj_timerChecksColorSlow.string, cg.chColorSlow, tj_timerChecksAlpha.value, "tj_timerChecksColorSlow");
				else if (cv->vmCvar == &tj_timerChecksColorFast || cv->vmCvar == &tj_timerChecksAlpha)
					BG_setColor(tj_timerChecksColorFast.string, cg.chColorFast, tj_timerChecksAlpha.value, "tj_timerChecksColorFast");
				...
				else if (cv->vmCvar == &tj_viewlog)
					trap_Cvar_Set("viewlog", tj_viewlog.string);
			}
		}
	}
...
void CG_setClientFlags(void)
{
	...
	trap_Cvar_Set("cg_uinfo", va("%d %d %d %d %d %d %s %i",
								 // Client Flags
								 (
									 ...
									 ((tj_nofatigue.integer > 0) ? CGF_NOFATIGUE : 0) |
									 ((tj_resetVelocityOnLoad.integer > 0) ? CGF_RESETVELOCITY : 0) |
									 ((tj_loadViewAngles.integer > 0) ? CGF_LOADVIEWANGLES : 0) |
									 ((tj_cpmTimes.integer > 0) ? CGF_CPMTIMES : 0) |
									 ((tj_bpTimes.integer > 0) ? CGF_BPTIMES : 0) |
									 ((tj_autoLogin.integer > 0) ? CGF_AUTOLOGIN : 0) |
...
char *CG_generateFilename(void)
{
	...
	// Dini, new filename format
	return va("%s_%s_%s-%02d-%02d_%02d-%02d-%02d",
			  cgs.clientinfo[cg.clientNum].cleanname,
			  Info_ValueForKey(pszServerInfo, "mapname"),
			  aMonths[ct.tm_mon],					// Month, Jan - Dec
			  ct.tm_mday, 1900 + ct.tm_year,		// Day-Year => Apr-16-2009
			  ct.tm_hour, ct.tm_min, ct.tm_sec	// Hour-Minutes-Seconds
			 );
}
...
");
	...
	*/
	...
	// CGaz 5
	//cgs.media.CGaz5			=		trap_R_RegisterShaderNoMip( "gfx/2d/cgaz5_6" );
	//cgs.media.CGaz5_custom	=		trap_R_RegisterShaderNoMip( "gfx/2d/cgaz5" );

	cgs.media.ArrowL		=		trap_R_RegisterShaderNoMip("gfx/2d/arrow_left");
	cgs.media.ArrowR		=		trap_R_RegisterShaderNoMip("gfx/2d/arrow_right");

	// "prefix" image for spectators speccing someone
	cgs.media.specArrow		=		trap_R_RegisterShaderNoMip("gfx/2d/specarrow");

	//cgs.media.timer1		=		trap_R_RegisterShaderNoMip( "gfx/2d/timer/timer_1" );

	cgs.media.gsT1 = trap_R_RegisterShaderNoMip("gfx/2d/gs/t1");
