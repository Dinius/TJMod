...
ammotable_t ammoTableMP[WP_NUM_WEAPONS] =
{
	...
	{	999,			0,		999,	0,		0,		1000,	DELAY_THROW,	1600,	0,		0,		MOD_GRENADE_LAUNCHER	},	// WP_GRENADE_LAUNCHER		// 4

	{	999,			1,		999,	0,		999,	0,		0,				800,	0,		0,		MOD_PANZERFAUST			},	// WP_PANZERFAUST			// 5	// DHM - Nerve :: updated delay so prediction is correct
	...
	{	999,			0,		999,	0,		0,		1000,	DELAY_THROW,	1600,	0,		0,		MOD_GRENADE_PINEAPPLE	},	// WP_GRENADE_PINEAPPLE		// 9

	{	96,				0,		32,		32,		32,		3100,	DELAY_LOW,		150,	0,		0,		MOD_STEN				},	// WP_STEN					// 10
	{	999,			0,		999,	0,		0,		1500,	50,				1000,	0,		0,		MOD_SYRINGE				},	// WP_MEDIC_SYRINGE			// 11
	{	1,				0,		1,		0,		0,		3000,	50,				1000,	0,		0,		MOD_AMMO,				},	// WP_AMMO					// 12
	{	0,				1,		0,		0,		0,		3000,	50,				10000,	100,	30000,	MOD_ARTY,				},	// WP_ARTY					// 13
	...
	{	0	,			0,		0,		0,		1,		0,		50,				0,		0,		0,		MOD_AIRSTRIKE			},	// WP_SMOKE_MARKER			// 22
	{	30,				0,		8,		16,		8,		1500,	DELAY_LOW,		1000,	0,		0,		MOD_KAR98				},	// WP_KAR98					// 23		K43
	{	24,				0,		8,		16,		8,		1500,	DELAY_LOW,		1000,	0,		0,		MOD_CARBINE				},	// WP_CARBINE				// 24		Engi Rifle
	...
	{	4,				0,		1,		4,		1,		3000,	DELAY_LOW,		400,	0,		0,		MOD_GPG40				},	// WP_GPG40					// 39		Engi Rifle@nade
	...
	{	999,			0,		999,	0,		0,		1500,	50,				1000,	0,		0,		MOD_SYRINGE				},	// WP_MEDIC_ADRENALINE		// 46
...
qboolean BG_IsAkimboSideArm(int weaponNum, playerState_t *ps)
{
	...
	{
		case WP_COLT:
			if (ps->weapon == WP_AKIMBO_COLT || ps->weapon == WP_AKIMBO_SILENCEDCOLT)		return qtrue;
			break;
		case WP_LUGER:
			if (ps->weapon == WP_AKIMBO_LUGER || ps->weapon == WP_AKIMBO_SILENCEDLUGER)	return qtrue;
			break;
	}
	return qfalse;
}
