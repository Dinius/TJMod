/*
 * Items are any object that a player can touch to gain some effect. Pickup
 * will return the number of seconds until they should respawn. All items
 * should pop when dropped in lava or slime. Respawnable items don't actually
 * go away when picked up, they are just made invisible and untouchable. This
 * allows them to ride movers and respawn apropriately.
 */
