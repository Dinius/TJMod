/*
 * Misc entities (lights, gamemodels, teleports and others).
 */
...
void TeleportPlayer(gentity_t *player, vec3_t origin, vec3_t angles)
{
	...
	// spit the player out
	// Enabled coz zero whined about it :P
	if (tjg_q3teles.integer || tjg_recordMode.integer)
	{
	...
	if (player->client->sess.resetspeedontele == qtrue)
	{
