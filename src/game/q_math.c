...
vec4_t	colorBlack		=	{0, 0, 0, 1};	// 0
vec4_t	colorRed		=	{1, 0, 0, 1};	// 1
vec4_t	colorGreen		=	{0, 1, 0, 1};	// 2
vec4_t	colorYellow		=	{1, 1, 0, 1};	// 3
vec4_t	colorBlue		=	{0, 0, 1, 1};	// 4
vec4_t	colorCyan		=	{0, 1, 1, 1};	// 5
vec4_t	colorMagenta	=	{1, 0, 1, 1};	// 6
vec4_t	colorWhite		=	{1, 1, 1, 1};	// 7
vec4_t	colorOrange		=	{1, 0.5, 0, 1};	// 8
...
vec4_t	colorD			=	{0, 0.5, 1, 1};				// D
vec4_t	colorF			=	{0.2f, 0.6f, 0.8f, 1.0 };	// F
